"""
Django settings for rocketlang project.
...
DATABASE_NAME = os.environ.get('DATABASE_NAME', 'rocketlang')
...
WSGI_APPLICATION = 'rocketlang.wsgi.application'
...
if DEBUG:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.path.join(BASE_DIR, 'rocketlang.db'),
        }
    }
else:
    DATABASES = {
